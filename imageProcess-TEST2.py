...
orig_picture = 'E:/study/DL/1(validation)'
gen_picture = 'E:/study/DL/1(validation)'


#t = grayImageProcessor.GaryIP(orig_picture, gen_picture)
t = RGBImageProcessor.RGBIP(orig_picture, gen_picture, "RGBImage_validation.tfrecords")
print(t.classes)
print(t.num_samples)
os.system("pause")
t.create_record()
